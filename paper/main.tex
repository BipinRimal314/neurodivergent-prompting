...
\subsection{Full Phase 2 Experiment}

The full Phase 2 experiment applies the same methodology as Phase 1 (10 tasks, 2 framings, 25 iterations per cell) to six severe conditions, yielding 3,000 additional API calls. Results for this phase, including statistical analysis against control with effect sizes, will be reported alongside Phase 1 findings. The combined 12-condition dataset (6,000 total calls) enables direct comparison of behavioral modulation magnitude between high-functioning and debilitating conditions.
